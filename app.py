...
def get_account_credentials(region: str) -> str:
    r = region.upper()
    if r == "IND":
        return "uid=4040049305&password=4584429AF89FBD1075A91E8844FD8E9C0BC1CF95631BE73A323CC9AB3B275B3B"
    elif r in {"BD", "ME", "SG", "PK"}:
        return "uid=4150102161&password=3CEFB60FAC2DE4AC37ADC124BED67C6E27E1EBDAE550A69F0D6A531F2DF941DF"
    else:
        return "uid=4150102161&password=3CEFB60FAC2DE4AC37ADC124BED67C6E27E1EBDAE550A69F0D6A531F2DF941DF"
